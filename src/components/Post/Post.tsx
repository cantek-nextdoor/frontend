        ...
        <Paper elevation={2} sx={{height: "fit-content", width: "70%"}}>
            <div style={{display: "flex", flexDirection: "column", padding: 15, gap: 20}}>
                ...
                <div style={{display: "flex", flexWrap: "wrap", gap: 20}}>
                    {currentPost.photo.map((item, index) => <img key={item} src={item} alt={`${item} ${index}`}
                ...
                <RowComponent>
                    {currentPost.Liked === 0 ?
                        ...
                        :
                        <div style={{display: "flex", alignItems: "center", gap: 5}}><ThumbUpIcon
                            sx={{color: blue[500]}}/> {currentPost.Liked}</div>
                    }
